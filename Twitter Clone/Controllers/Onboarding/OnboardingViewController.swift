...
class OnboardingViewController: UIViewController {
    ...
    private let loginButton: UIButton = {
        ...
        button.tintColor = UIColor(red: 29/255,
                                   green: 161/255,
                                   blue: 242/255,
                                   alpha: 1)
        return button
    ...
    private func configureConstraits(){
        ...
        NSLayoutConstraint.activate(welcomeLabelConstraits)
        NSLayoutConstraint.activate(createAccountButtonConstraits)
        NSLayoutConstraint.activate(promptLabelConstraits)
        NSLayoutConstraint.activate(loginButtonConstraits)
    }
